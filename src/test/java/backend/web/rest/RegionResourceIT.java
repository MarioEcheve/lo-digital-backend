...
import backend.domain.Region;
import backend.repository.RegionRepository;
...
public class RegionResourceIT {
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getNombre()).isEqualTo(DEFAULT_NOMBRE);
    }
    ...
    public void updateRegion() throws Exception {
        ...
        Region testRegion = regionList.get(regionList.size() - 1);
        assertThat(testRegion.getNombre()).isEqualTo(UPDATED_NOMBRE);
    }
