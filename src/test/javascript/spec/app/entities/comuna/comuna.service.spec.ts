...
describe('Service Tests', () => {
  describe('Comuna Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(ComunaService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Comuna(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Comuna', () => {
        ...
        service.create(new Comuna()).subscribe(resp => (expectedResult = resp.body));
